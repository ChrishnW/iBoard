    ...
    <div id="user_dashboard" class="user_dashboard container-fluid rounded py-1">
        ...
        <div class="row align-items-center px-3 py-3">
            ...
            <div class="col-12 col-sm-auto text-center mt-3 mt-sm-0">
                ...
                <br>
                <span class="h3 font-weight-bold mb-0 text-danger" id="timer"><?php echo !empty($row_records["timer_stop"]) ? $row_records["timer_stop"] : "00:00:00:000" ?></span>
            </div>
                    ...
                    <tbody class="bg-white text-dark h4">
                        <tr style="height: 180px;">
                            ...
                            <td class="position-relative" style="height: 160px;">
                                ...
                                <div class="position-absolute w-100 d-flex justify-content-between" style="top: 85%; transform: translateY(-75%);"> <!-- Adjusted top -->
...
<script>
    ...
    let time = <?php echo !empty($row_records["timer_stop"]) ? convertToMilliseconds($row_records["timer_stop"]) : 0 ?>;
    let milliseconds = 0;
    var isStartLogin = 1;
